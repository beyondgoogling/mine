...
acc_name = 'sylak'                                #Replace skylak with your steem account name.
s = Steem(nodes, keys=['5KUNThScKBJF6cQwpfCgPtei5TnQb2BwPs7xMzaFrita6cua5LL', 'Your_Private_Active_Key'])
